...
public class Controller implements Initializable {
    ...
    public void drawPlayerPlaces(Player player) {
        switch (player.getPlaceId()) {
            case 1: {
                button1.setDisable(true);
                button1.setText(player.getUsername());
                break;
            }
            case 2: {
                button2.setDisable(true);
                button2.setText(player.getUsername());
                break;
            }
            case 3: {
                button3.setDisable(true);
                button3.setText(player.getUsername());
                break;
            }
            case 4: {
                button4.setDisable(true);
                button4.setText(player.getUsername());
                break;
            }
            case 5: {
                button5.setDisable(true);
                button5.setText(player.getUsername());
                break;
            }
        }
    }
